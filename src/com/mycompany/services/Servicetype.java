...
public class Servicetype {
    ...
    //ajout 
    public void ajoutReclamation(type reclamation) {
        
        String url =Statics.BASE_URL+"/addTypeJSON/new?nombre="+reclamation.getNombre()+"&nom="+reclamation.getNom()+"&description="+reclamation.getDescription(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
    ...
    public ArrayList<type>affichagetype() {
        ArrayList<type> result = new ArrayList<>();
        
        String url = Statics.BASE_URL+"/allType";
        req.setUrl(url);
